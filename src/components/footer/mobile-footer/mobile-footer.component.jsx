      ...
      <div className="MobileFooterWrapper">
        <div className="MobileFooter-Top">
          <form className="MobileFooter-Form" onSubmit={HandleSubmit}>
            <input
              className="MobileFooter-FormInput"
              type="email"
              name="email"
              placeholder="Join Our Newsletter"
            ></input>
            <button type="submit" className="MobileFooter-FormSubmit">
              JOIN
            </button>
          </form>
          <p className="MobileFooter-Left-Text">
            By submitting your email address you agree to the{" "}
          </p>
          <p className="MobileFooter-Left-Text MobileFooter-Terms">
            Terms & Conditions
          </p>
        </div>
