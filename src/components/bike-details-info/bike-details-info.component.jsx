...
export default function BikeDetailsInfo() {
  return (
    <div className="Description-Demo8">
      <div className="Description-StumpJumperPro29-Wrap">
        <p className="Description-Text Para-1">
        ...
        <ul className="Description-List">
          <li className="Description-Text Description-ListItem">
